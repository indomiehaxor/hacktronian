...
echo -e "${RED}                                                      ~ Tools for Hacking by indomie haxor ${NC}"
echo ""
echo -e "${YELLOW} Twitter.com/indomiehaxor | Instagram.com/indomie.haxor | Github.com/indomiehaxor ${NC} "
echo ""
echo "---------------------------------------------------------------------------------------"
echo ""
...
echo "[✔] Installing ...";
echo "";
git clone https://github.com/indomiehaxor/hacktronian.git "$INSTALL_DIR";
echo "#!/bin/bash
